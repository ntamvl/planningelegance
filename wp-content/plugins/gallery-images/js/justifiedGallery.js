 ...
 */
(function($) {
     if(imagejustify == true) { var imagejustify2 = 'justify'; }
     if(imagejustify == false) { var imagejustify2 = 'nojustify'; }
	...
	*/
	...
	$.fn.justifiedGallery = function (arg) {
		...
		var defaults = {
			...
			fixedHeight : true,
			captions : imageshowcaption,
			cssAnimation: imagecssAnimation2,
			imagesAnimationDuration : imagecssAnimationSpeed, //ignored with css animations
