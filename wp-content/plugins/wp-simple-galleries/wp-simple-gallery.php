...
define('WPSIMPLEGALLERY_VERSION', '1.34');
...
class wpsimplegallery {
    ...
    public function inner_custom_box($post) {
        ...
        <input id="wpsimplegallery_upload_button" data-uploader_title="Upload Image" data-uploader_button_text="Select" class="upload_button button" type="button" value="<?php echo __('Upload Image', 'wpsimplegallery'); ?>" rel="" />
    ...
    private function thumb($id, $post_id) {
        ...
        $title_string = wpsg_of_get_option('wpsimplegallery_caption', '%title%');
