...
function twentyfourteen_widgets_init()
{
    ...
    register_sidebar(array(
        'name' => __('Subscribe', 'twentyfourteen'),
        'id' => 'subscribenow',
        'description' => __('Additional sidebar that appears on the right.', 'twentyfourteen'),
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
...
function get_excerpt($count){
    ...
    $excerpt = $excerpt.'... <a href="'.$permalink.'"> reading more</a>';
    return $excerpt;
}
...
// 167.160.168.77:85
// update_option('siteurl', 'http://167.160.168.77:85');
// update_option('home', 'http://167.160.168.77:85');
